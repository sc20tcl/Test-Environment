...
data_array = [data['1998-06-24 13:29:00': '1998-06-24 14:49:00'],  data['1998-06-24 15:42:00': '1998-06-24 17:02:00'], data['1998-06-24 19:51:00': '1998-06-24 21:11:00']]
...
for i in range(len(data_array)):
    test_data = []
    warm_up = 0
    first_timestamp = data_array[i].index[0].strftime('%Y-%m-%d %H:%M:%S')
