...
def run_stage(stage):
    test_command = f"k6 run -e RATE={int(stage['rate']/3)} -e DURATION={stage['duration']} -e PREALLOCATED_VUS={int(stage['preAllocatedVUs']*1.5)} -e MAX_VUS={int(stage['maxVUs']*2.5)} ./k6Job.js"
